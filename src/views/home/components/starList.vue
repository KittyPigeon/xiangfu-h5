  ...
  <div class="favorite-filter" @click.stop>
    ...
    <div class="filter-content" :class="{ expanded: isExpanded }">
      ...
      >
        ...
        <!-- 点击选中 -->
        <div v-if="activeIndex === item.id" class="label-check">
    ...
    .filter-item {
      ...
      .item-icon {
        ...
        .icon {
          ...
          &.icon-shopping {
            background: url("../../../assets/images/icon-shopping.png")
              no-repeat center;
            background-size: cover;
          }

          &.icon-entertainment {
            background: url("../../../assets/images/icon-entertainment.png")
              no-repeat center;
            background-size: cover;
          }

          &.icon-hotel {
            background: url("../../../assets/images/icon-hotel.png") no-repeat
              center;
            background-size: cover;
          }

          &.icon-fitness {
            background: url("../../../assets/images/icon-fitness.png") no-repeat
              center;
            background-size: cover;
          }

          &.icon-medical {
            background: url("../../../assets/images/icon-medical.png") no-repeat
              center;
            background-size: cover;
          }

          &.icon-scene {
            background: url("../../../assets/images/icon-scene.png") no-repeat
              center;
            background-size: cover;
          }
          &.icon-education {
            background: url("../../../assets/images/icon-education.png")
              no-repeat center;
            background-size: cover;
          }
        }
...
// 结合之前的拖拽逻辑时，可修改 max-height 为动态计算，这里简化为点击展开
</style>
